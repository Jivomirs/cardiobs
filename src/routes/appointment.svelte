        ...
        <div class="contactInfoHeading">
            ...
            <div class="contactPanel">
                <div class="par separate">
                    <p>В Кардиологичен Център работим само със запазени часове, които спазваме. Правим всичко възможно да не се налага да чакате. Може да запишете час, като се обадите по телефона, пишете на е-мейл или през линка към Google Maps</p>
